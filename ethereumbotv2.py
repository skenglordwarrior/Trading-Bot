...
def get_uncx_lookup_status() -> Dict[str, Optional[str]]:
    """Expose the current Uncx lookup enablement state for diagnostics."""

    return {
        "enabled": UNCX_LOOKUPS_ENABLED,
        "disabled_reason": UNCX_DISABLED_REASON,
    }
