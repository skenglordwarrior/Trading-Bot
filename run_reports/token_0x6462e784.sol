...
WEB: https://littlepepe.best
X: https://x.com/thelilpepe
TG: https://t.me/littlepepe_erc
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isLILPEPEylyIlExcludedFromFee;
    ...
    constructor () payable  {
        ...
        _isLILPEPEylyIlExcludedFromFee[owner()] = true;
        _isLILPEPEylyIlExcludedFromFee[address(this)] = true;
        _isLILPEPEylyIlExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isLILPEPEylyIlExcludedFromFee[to] ) {
